...
O sistema de Workflows do AIOS foi **parcialmente migrado** do Claude Code para o AntiGravity. A migração original (documentada em `.synapse/antigravit/walkthrough-migracao-claude.md`) criou apenas 4 workflows em `.antigravity/workflows/`, enquanto o AIOS possui **14 workflows documentados** em `docs/aios-workflows/` e **15 YAMLs estruturados** em `.aios-core/development/workflows/`.
...
| ---------------------------------- | --------------------------------------------------------- |
| Auditoria de Gaps                  | `.synapse/antigravit/revWorkFlows/audit-workflows-gap.md` |
| Checklist de Execução              | `.synapse/antigravit/revWorkFlows/task.md`                |
| Índice de Workflows AntiGravity    | `.antigravity/workflows/README.md`                        |
| Histórico da Migração Original     | `.synapse/antigravit/walkthrough-migracao-claude.md`      |
