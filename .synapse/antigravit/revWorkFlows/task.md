...
- [x] **T1.6** Criar tabela de gap completa → `.synapse/antigravit/revWorkFlows/audit-workflows-gap.md` ✅
...
- [x] **T7.2** Atualizar `.synapse/antigravit/walkthrough-migracao-claude.md` — pendente revisit
